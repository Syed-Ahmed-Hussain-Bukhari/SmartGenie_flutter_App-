...
import 'package:ai_chat_bot/View/AuthenticationView.dart/ForgotPassword.dart';
import 'package:ai_chat_bot/View/AuthenticationView.dart/SignUpView.dart';
...
import 'package:ai_chat_bot/controller/LoginViewController.dart';
...
class LoginView extends StatelessWidget {
  ...
  Icon passwordHideIcon=Icon(Icons.visibility_off,color:  MyColors.userTextColor,);
  bool passwordHideChecker=false;
   
   final _LoginViewController=Get.put(LoginViewController());
        ...
        children: [
          Column(
            ...
            children: [
              ...
              myText(context, "Login", MyColors.userTextColor, 28, 0.08, 0),
              ...
              myText(context, "Password", MyColors.userTextColor, 18, 0.09, 0.035),
                    // myTextField(context, 0.8, 55, 0.09, 0.01, MyColors.mainColor, MyColors.userTextColor,"Password",passwordController,passwordHideChecker,suffixIcon: passwordHideIcon),
              Obx(() => Container(
              ...
              Center(child: InkWell(
                ...
                child:myText(context, "Forgot password?", MyColors.mainColor, 17, 0, 0),),),
              Center(
                child:  InkWell(
                    onTap: () {
                      _LoginViewController.loginUser(context, emailController.text.toString(), passwordController.text.toString());
              ...
              Row(
                    ...
                    children: [
                      myText(context, "Don't have an account?",
                      ...
                      InkWell(
                        ...
                        child:Container(
                          ...
                          child: Text("Sign Up",style: TextStyle( decoration: TextDecoration.underline,color: MyColors.mainColor,fontSize: 18,fontWeight: FontWeight.bold),)),
                 ...
                 //
                  Row(
                    ...
                    children: [
                      ...
                      myText(context, "Sign in with",  MyColors.userTextColor, 17, 0.01, 0),
                      Container(
